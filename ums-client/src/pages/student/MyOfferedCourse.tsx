...
import { useGetAllOfferedCourseQuery, useGetMyOfferedCourseQuery } from "../../redux/features/admin/courseManagementApi";
...
export const MyOfferedCourse = () => {
	...
	const { data: offeredCourseData, isFetching } =
        ...
        const {data: myCourse} = useGetMyOfferedCourseQuery(params)

        console.log("aah halil ibrahim",myCourse)
