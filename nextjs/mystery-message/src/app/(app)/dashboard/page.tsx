...
import { AcceptSchemaValidation } from "@/schemas/accept-message-scheam-validation";
...
function UserDashboard() {
	...
	const form = useForm({
		resolver: zodResolver(AcceptSchemaValidation),
	});
	...
	const fetchAcceptMessages = useCallback(async () => {
		...
		try {
			const response = await axios.get<IApiResponse>("/api/message-acceptance");
